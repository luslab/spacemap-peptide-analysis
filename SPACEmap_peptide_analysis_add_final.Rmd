...
unmatched.proteins.other_matches %>%
  filter(site.matched) %>%
  filter(match.peptide.overlap) %>%
  filter(ipr.accession == "IPR017923")
...
We manually classified these non-DBDs into those expected and unexpected for chromatin proteins. We will use this classification below, in the overall plot of different fractions of proteins.
...
3) Do not have CLF peptides from IDRs, but have CLF peptides from non-DBD domains.
